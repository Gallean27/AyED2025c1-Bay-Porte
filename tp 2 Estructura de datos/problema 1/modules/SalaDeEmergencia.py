...
import ColaDePrioridad as cp # Importar nuestra nueva cola de prioridad
import random

n = 20  # cantidad de ciclos de simulación

cola_de_espera = cp.ColaDePrioridad() # ¡Cambiamos a nuestra ColaDePrioridad!
...
for i in range(n):
    ...
    # Sin embargo, para no alterar la cola, simplemente imprimimos el contenido del heap interno.
